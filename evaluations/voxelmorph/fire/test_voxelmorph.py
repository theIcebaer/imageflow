...
def show_test_samples(model_path):
    ...
    make_fig_from_batch(source.detach().numpy(), save_path="plots/source")
    make_fig_from_batch(target.detach().numpy(), save_path="plots/target")
...
# test_voxelmorph_model("/home/jens/thesis/imageflow/evaluations/voxelmorph/fire/voxelmorph_model.pt")
show_test_samples("/home/jens/thesis/imageflow/evaluations/voxelmorph/fire/voxelmorph_model.pt")