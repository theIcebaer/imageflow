...
for dir in glob.glob("supervised*"):
    ...
    model_dir = f"{dir}/checkpoints/model_30_0.pt"
    # model_dir = f"{dir}/checkpoints/model_2.pt"
    data_dir = "../../../../../data"
    ...
    if not os.path.isdir(plot_dir):
        ...
        print(f"{plot_dir} already done. skipping.")
        continue
    ...
    im_errors[mult] = round(im_test_err, 3)
    field_errors[mult] = round(field_test_err, 3)
    print(field_errors[mult])
    print(im_errors[mult])
# im_table = ["l1 & l2 \\\\ \n"]
# field_table = ["l1 & l2\\\\ \n"]
#
