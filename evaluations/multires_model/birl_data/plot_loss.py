...
import glob
for path in glob.glob("reduced*"):
    log_path = os.path.join(path, "loss.log")
    print(log_path)
    run_avg_nll, run_avg_val, reg_loss, ticks, labels = get_plot(log_path)
    # run_avg_nll_0, run_avg_val_0, reg_loss_0, ticks_0, labels_0 = get_plot("grad_loss_5_128_l1_0.1_4_(32, 64, 128)_(64, 128, 256)_((2, 6), (4, 4))_(1, 0)/loss.log")
